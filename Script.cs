...
} public void Main(string argument, UpdateType updateSource)
{
    ...
    bool massWatermarkReached = massWatermarkValid && (currentMass >= massWatermarkValue);     if (massWatermarkReached)
    {
    ...
    bool volumeWatermarkReached = volumeWatermarkValid && (currentVolume * 1000 >= volumeWatermarkValue);     if (volumeWatermarkReached)
    {
    ...
    Print($"Maximum volume: {maxVolume * 1000} L", surface);     if (volumeWatermarkValid)
    {
...
{
    Dictionary<String, String> result = new Dictionary<String, String>();     if (source == null || source.Length < 1)
    {
        return result;
